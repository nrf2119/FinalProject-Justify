 ...
 */
public class WritingTabPagerAdapter extends PagerAdapter {
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        switch (position) {
            case 0:
                view = new WritingClaimView(container.getContext());
                break;
            case 1:
                view = new WritingEvidenceView(container.getContext());
                break;
            case 2:
                view = new WritingJustificationView(container.getContext());
                break;
            default:
